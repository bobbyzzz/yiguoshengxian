          ...
          <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="getData">
            <div class="box-fpx">
              <div class="flex j-between a-center">
                <div class="flex" style v-for="(item, index) in wsw" :key="index" @click="toChilds(item)">
                  <a href="javascript:;">
...
export default {
  ...
  methods: {
    ...
    getnew() {
      this.$axios
        .get(
          "https://mock.yonyoucloud.com/mock/2164/knowledge/knowledgeList"
        )
        .then(res => {
          // console.log(res.data);
          this.wsw = res.data.RspData.ArticleList.List;
          //   console.log(this.RspMsg);
          // console.log(this.wsw);
        });
    },
    toChilds(e) {
      // console.log(e)
...
<style scoped>
@import '../static/css/Increaseknowledge.css';
</style>
